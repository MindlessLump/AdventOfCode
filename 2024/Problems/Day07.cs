...
namespace _2024.Problems
{
    public class Day07
    {
        ...
        private static bool SatisfiedByAddAndMult(long target, long runningTotal, int rightValueIndex, List<long> values)
        {
            ...
            {
                // Base case: see if running total matches the target
            ...
            else
            {
                ...
                return SatisfiedByAddAndMult(target, addValue, rightValueIndex + 1, values) ||
                    SatisfiedByAddAndMult(target, multValue, rightValueIndex + 1, values);
            }
        }
